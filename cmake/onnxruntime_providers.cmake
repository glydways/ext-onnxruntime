...
if (onnxruntime_USE_CUDA)
  ...
  function(config_cuda_provider_shared_module target)
    ...
    if (UNIX)
      ...
      target_compile_options(${target} PRIVATE "$<$<COMPILE_LANGUAGE:CUDA>:SHELL:-Xcompiler -Wno-error=unused-function>"
                  "$<$<NOT:$<COMPILE_LANGUAGE:CUDA>>:-Wno-error=unused-function>")
      target_compile_options(${target} PRIVATE "$<$<COMPILE_LANGUAGE:CUDA>:SHELL:-Xcompiler -Wno-error=unused-private-field>"
                  "$<$<NOT:$<COMPILE_LANGUAGE:CUDA>>:-Wno-error=unused-private-field>")
      target_compile_options(${target} PRIVATE "$<$<COMPILE_LANGUAGE:CUDA>:SHELL:-Xcompiler -Wno-error=inconsistent-missing-override>"
